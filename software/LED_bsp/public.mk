...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Qsys_LED.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x31040
SOPC_SYSID_FLAG += --sidp=0x31040
ELF_PATCH_FLAG  += --sidp 0x31040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1530350580
SOPC_SYSID_FLAG += --timestamp=1530350580
ELF_PATCH_FLAG  += --timestamp 1530350580
